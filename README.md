# 百度ife学院任务（已完成）
### demo:
http://yiiu.github.io/baidu-ife/{{任务完整名称}}

如：http://yiiu.github.io/baidu-ife/task-4-50/ 访问
...
* 任务49：更炫酷的游戏实现
   ...
   同前两个阶段一样，这二十四个任务**并非所有人都要去完成**，每个团队可以在这3个系列中任选一个进行实践。

# IFE春季班第四阶段任务
  大家好，第四阶段的任务已经在 [http://ife.baidu.com](http://ife.baidu.com) 上发布，大家访问官网首页，点击 查看任务 按钮即可进入到任务列表页面。或直接访问 [http://ife.baidu.com/task/all](http://ife.baidu.com/task/all)
